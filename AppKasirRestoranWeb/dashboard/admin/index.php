<div class="container mt-3">
  <?php if (isset($_SESSION['pesan'])) : ?>
    ...
    <div class="card mb-3">
      <img src="assets/image/halaman.png" class="card-img-top" height="180">
      <div class="card-body">
          <h3 class="card-title">Selamat Datang di Pak Resto Unikom</h3>
          <p class="card-text">Sistem Kasir Restoran</p>
      </div>
    </div>
    <h3 class="mb-3">Menu Makanan</h3>
    <div class="row">
      <div class="col-md-12">
        <div class="row">
